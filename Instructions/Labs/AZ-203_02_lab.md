...
1.  Deploy the **api.zip** file to the **Web app** you created earlier in this lab:
...
1. Access the **imgapi\*** *Web app* you created earlier in this lab.

1. Open the **imgapi\*** *Web app* in your browser.
